...
import CompanyDashboard from "@/components/common/ReviewDashBoard";
  ...
  return company ? (
    ...
    <div className="flex flex-col items-center justify-center h-[60vh] text-center space-y-6 p-6 bg-card/80 rounded-2xl shadow-sm">
      ...
      <button
        ...
        className="px-6 py-3 bg-primary hover:bg-primary/80 text-primary-foreground font-medium rounded-xl transition duration-200 cursor-pointer"
      >
