            ...
            >
              ...
              <div className="border-t border-foreground/60 px-6 py-3 bg-card flex justify-end gap-3">
                {application.status === "PENDING" && (
                  <button
                    onClick={() => handleUnsend(application.id)}
                    className="text-sm font-medium bg-popover text-foreground/70 cursor-pointer hover:text-red-800 px-3 py-1.5 rounded hover:bg-foreground/90 transition-colors"
                  >
                    Unsend Proposal
                  </button>
                )}
                <button
                  ...
                  className="text-sm font-medium bg-popover text-foreground/70 cursor-pointer hover:text-primary px-3 py-1.5 rounded hover:bg-foreground/90 transition-colors"
                >
                  Delete Application
                </button>
              </div>
