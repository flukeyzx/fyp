    ...
    <section className="relative w-full flex flex-col items-center justify-center text-center px-4 py-20 bg-background">
      ...
      <div className="relative z-10">
        ...
        <Button
          ...
          className="mt-6 bg-gradient-to-r from-secondary/70 via-primary/70 to-primary/90 hover:opacity-90 hover:scale-[1.02] text-background px-8 py-3 rounded-2xl text-lg shadow-lg transition cursor-pointer"
        >
          Get Started
        </Button>
