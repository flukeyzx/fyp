    ...
    <div className="bg-card rounded-xl shadow-sm overflow-hidden mt-8">
      <div className="p-6 flex justify-between items-center">
        ...
        <Link
          ...
          className="flex items-center px-3 py-2 bg-foreground text-background rounded-lg cursor-pointer hover:opacity-90 hover:scale-[1.02] transition"
        >
      ...
      <div className="justify-center pb-12 p-4 border-b border-foreground/50 flex flex-wrap gap-4">
        <div className="flex rounded-l-lg overflow-hidden flex-1 max-w-md">
          <Input
            type="text"
            ...
            className="!h-10"
          />
          <Button className="bg-foreground rounded-lg ml-3 text-background hover:bg-foreground/90 cursor-pointer">
