...
const SuggestedCompanies = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="flex flex-wrap gap-6 mb-10 max-h-[calc((theme(height.96)+1.5rem)*2)] overflow-hidden">
        ...
        max-w-full
        rounded-xl backdrop-blur-md border bg-gradient-to-br from-primary/5 via-background to-secondary/10 hover:bg-primary/5 cursor-pointer py-6 px-4 shadow-md hover:shadow-xl transition group overflow-hidden
      `}
          >
